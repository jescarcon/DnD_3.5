...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('characters', '0002_alter_character_characterclass_delete_characterclass'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='character',
            name='image',
            field=models.ImageField(default='characters/default.png', upload_to='characters/images/'),
        ),
        migrations.CreateModel(
            name='Items',
            fields=[
